...
$config = mysqli_query($db_connect, "SELECT * FROM config");
$config_data = mysqli_fetch_assoc($config);
mysqli_free_result($config);
...
.card {
  background: linear-gradient(to bottom, #e84c3d 0%, #e84c3d 20%, #ecedef 20%, #ecedef 100%);
  height: 20em;
  float: left;
  position: relative;
  padding: 1em;
            ...
            <div class="col-md-12">
                ...
                <div class="cardWrap">
                    <div class="card cardLeft">
                        <h1>Startup <span>Cinema</span></h1> <!-- Airline -->
                        <div class="title">
                        ...
                        <div class="seat">
                        <h2><?php echo htmlspecialchars($flight_data ? $flight_data['flight_id'] : 'N/A'); ?></h2>
                        <span>Flight</span>
                        </div>
                        <div class="seat">
                        <h2><?php echo htmlspecialchars($boardingpass_data['dep_gate']); ?></h2>
                        <span>gate</span>
                        </div>
                        <div class="time">
                        <h2><?php echo htmlspecialchars($flight_data['dep_date'] ?? 'N/A'); ?></h2>
                        <span>date</span>
                        </div>
                        <div class="time">
